...
class GitHubStore
    ...
    def create(self, object_id: str, data: Json, extra_labels: str | None) -> StoredObject
        """Create a new object in the store"""
...
class IssueHandler
    ...
    def create_object(self, object_id: str, data: Json, extra_labels: list | None) -> StoredObject
...
def _configure_handler(comment_handler: CommentHandler, unprocessed_updates_factory: Callable[[Any, List[Update]]])
    """
